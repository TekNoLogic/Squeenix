...
local frames = {MinimapToggleButton = "close button", GameTimeFrame = "time frame", MinimapZoneTextButton = "zone text", MiniMapWorldMapButton = "world map", MiniMapVoiceChatFrame = "voice chat", MiniMapTracking = "tracking"}
local GAP = 8
